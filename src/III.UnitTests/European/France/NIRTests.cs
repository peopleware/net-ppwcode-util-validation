...
using PPWCode.Util.Validation.III.European.France;

namespace PPWCode.Util.Validation.III.UnitTests.European.France
{
    ...
    public class NIRTests : BaseTests
    {
        ...
        public static IEnumerable PaperVersions
        {
            get
            {
                foreach (object insee in StrictValidIdentifications)
                {
                    yield return new TestCaseData("151024610204372").Returns("1 51 02 46102 043 72");
                }
            }
        }
        ...
        {
            get { yield return new TestCaseData("151024610204372").Returns(Sexe.MALE); }
        }
